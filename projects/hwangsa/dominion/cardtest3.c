...
int main() {
	...
	cardEffect(village, choice1, choice2, choice3, &state, hand_pos, &bonus);

	printf("\nPlayer_0 gains 1 card\n");
	assertTrue(state.handCount[player_0],og_state.handCount[player_0]);

	printf("\nPlayer_0 gains 1 card from his own pile\n");
	assertTrue(state.deckCount[player_0],og_state.deckCount[player_0]-1);

	printf("\nPlayer_0 gains 2 actions\n");
	assertTrue(state.numActions,og_state.numActions+2);
	...
	printf("Deck count\n");
	assertTrue(state.deckCount[player_1],og_state.deckCount[player_1]);
